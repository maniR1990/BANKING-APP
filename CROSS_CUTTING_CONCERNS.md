...
The LGTM stack (Loki, Grafana, Tempo, Mimir/Prometheus) is the recommended open-source path for correlating logs, traces, and metrics.

> **Note:** For a detailed, step-by-step implementation guide specific to our current NestJS/Nx microservices Docker architecture, please refer to [LGTM_STACK_SETUP.md](./LGTM_STACK_SETUP.md).
